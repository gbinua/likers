...
DATA;
    ...
    echo "$yelow";
    $curl = curl_init();
    curl_setopt_array($curl, array(CURLOPT_URL => 'https://posting.mylykaapps.com/api/v3/posts/addpost', CURLOPT_RETURNTRANSFER => true, CURLOPT_ENCODING => '', CURLOPT_MAXREDIRS => 10, CURLOPT_TIMEOUT => 0, CURLOPT_FOLLOWLOCATION => true, CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1, CURLOPT_CUSTOMREQUEST => 'POST', CURLOPT_POSTFIELDS => array('boundary' => '3f6c465f-284e-40e1-98ae-f11ef08d5413', 'title' => ", 'content' =>" , 'url' => '', 'descriptionUrl' => '', 'imageUrl' =>$img[array_rand($img) ], 'hashtags' => '', 'deviceid' => '1CC717193BE3CE8B', 'devicemodel' => '', 'deviceos' => 'OPPO A3S', 'osversion' => 'Android O_MR1', 'mediaTags' => '28'), CURLOPT_HTTPHEADER => array("authorization: Bearer $nt", "user-agent: Lyka/3.6.21 (com.thingsilikeapp; build:821 Android O_MR1 28)"),));
    $response = curl_exec($curl);
    curl_close($curl);
    //echo $response;
    $json = json_decode($response);
...
";
    ...
    */
    ...
    curl_setopt($curlbals, CURLOPT_HTTPHEADER, $headers);
       $databals = '{"amount":"' . $css + $csst . '","device":{"deviceId":"f606c43d78f50669","deviceImei":"f606c43d78f50669","deviceModel":"RMX3191","deviceName":"RMX3191","deviceOs":"Android O_MR1 ","isEmulator":false,"notificationToken":"eFEXEC5pTAeXLu7JjIlpNX:APA91bF8I2ZGs8wUNDjpw5lSnzrz8fB652HYMxWBdTGtFRSUaBEd0pHZQvWXAd00ESKVUO_VtYieRQxtfEU7f3RUIHEs5zXGZSVqk5PfbzjZTJQcue0vHYRiEobXHk8JUlTa0nmPCdgR","osVersion":"28"},"recipientId":' .   $ididi  . '}';
